...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'wasm-soundmeter.wast';
  var wasmBinaryFile = 'wasm-soundmeter.wasm';
  var asmjsCodeFile = 'wasm-soundmeter.temp.asm.js';
...
var real___GLOBAL__sub_I_wasm_soundmeter_cc = asm["__GLOBAL__sub_I_wasm_soundmeter_cc"]; asm["__GLOBAL__sub_I_wasm_soundmeter_cc"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real___GLOBAL__sub_I_wasm_soundmeter_cc.apply(null, arguments);
};
...
var __GLOBAL__sub_I_wasm_soundmeter_cc = Module["__GLOBAL__sub_I_wasm_soundmeter_cc"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__GLOBAL__sub_I_wasm_soundmeter_cc"].apply(null, arguments) };
